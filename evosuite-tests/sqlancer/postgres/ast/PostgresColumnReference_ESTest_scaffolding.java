...
public class PostgresColumnReference_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.postgres.ast.PostgresColumnReference"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PostgresColumnReference_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "sqlancer.postgres.ast.PostgresColumnReference",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PostgresColumnReference_ESTest_scaffolding.class.getClassLoader()); 
