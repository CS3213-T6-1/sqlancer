...
public class CockroachDBRandomQuerySynthesizer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.cockroachdb.gen.CockroachDBRandomQuerySynthesizer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CockroachDBRandomQuerySynthesizer_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "sqlancer.cockroachdb.gen.CockroachDBRandomQuerySynthesizer",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CockroachDBRandomQuerySynthesizer_ESTest_scaffolding.class.getClassLoader()); 
