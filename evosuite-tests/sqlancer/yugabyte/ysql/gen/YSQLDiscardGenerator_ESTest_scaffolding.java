...
public class YSQLDiscardGenerator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.yugabyte.ysql.gen.YSQLDiscardGenerator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(YSQLDiscardGenerator_ESTest_scaffolding.class.getClassLoader() ,
      "sqlancer.MainOptions",
      "sqlancer.yugabyte.ysql.YSQLSchema",
      "sqlancer.Randomly",
      "sqlancer.common.query.SQLancerResultSet",
      "sqlancer.SQLDiscardGenerator",
      ...
      "sqlancer.SQLDiscardGenerator$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(YSQLDiscardGenerator_ESTest_scaffolding.class.getClassLoader()); 
